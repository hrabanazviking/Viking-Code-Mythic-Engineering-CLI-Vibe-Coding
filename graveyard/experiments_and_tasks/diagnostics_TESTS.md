...
@pytest.fixture
def instance():
    return Diagnostics(data_path="tests/data")
...
# With coverage
python -m pytest tests/unit/test_diagnostics.py --cov=diagnostics

# Specific test
python -m pytest tests/unit/test_diagnostics.py::test_basic_operation -v
```
