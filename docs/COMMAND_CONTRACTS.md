...
- Other declared hooks (`before_reflect`, `after_reflect`) remain wired through the dispatcher contract but are not yet emitted from the corresponding command code; they will be wired in subsequent slices.
